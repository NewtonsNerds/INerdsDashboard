...
$settings = array(
    ...
    'login_after_registration' => true,
         ...
         *
         * Determines if a captcha should be utilized on the user registration
         * form.
         ...
         * this to configure which Zend\Captcha adapter to use, and the options
         * to
         * pass to it. The default uses the Figlet captcha.
         */
        /*
         * 'form_captcha_options' => array( 'class' => 'figlet', 'options' =>
         * array( 'wordLen' => 5, 'expiration' => 300, 'timeout' => 300, ), ),
         */
        
        /**
         * Use Redirect Parameter If Present
         *
         * Upon successful authentication, check for a 'redirect' POST or GET
         * parameter
         *
         * Accepted values: boolean true or false
         */
         ...
         *
         * Upon successful login the user will be redirected to the entered
         * route
         *
         * Default value: 'zfcuser'
         * Accepted values: A valid route name within your application or a
         * callback.
         * If callback used, it will receive the identity as the param
         */
        'login_redirect_route' => 'home',
//         function ( \ZfcUser\Entity\UserInterface $user )
//         {
//             $roles = $user->getRoles();
//             foreach ($roles as $r){
//                 if ($r->getRoleId() == 'client'){
//                     return 'client';
//                 } else if ($r->getRoleId() == 'operator'){
//                     return 'operator';
//                 } else if ($r->getRoleId() == 'admin'){
//                     return 'admin';
//                 }
//             }
//         },
