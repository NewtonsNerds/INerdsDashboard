 ...
 */
class Project extends \Application\Entity\Project implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Application\\Entity\\Project' . "\0" . 'name', '' . "\0" . 'Application\\Entity\\Project' . "\0" . 'tasks', '' . "\0" . 'Application\\Entity\\Project' . "\0" . 'id', 'timeDeleted', '' . "\0" . 'Application\\Entity\\Project' . "\0" . 'createdBy', '' . "\0" . 'Application\\Entity\\Project' . "\0" . 'updatedBy', '' . "\0" . 'Application\\Entity\\Project' . "\0" . 'createdAt', '' . "\0" . 'Application\\Entity\\Project' . "\0" . 'updatedAt');
        }
